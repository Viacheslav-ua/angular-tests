...
import { AsyncNgExampleComponent } from "./async-ng-example.component";

describe("AsyncExampleComponent", () => {
  let component: AsyncNgExampleComponent;
  let fixture: ComponentFixture<AsyncNgExampleComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ AsyncNgExampleComponent ],
    })
    .compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(AsyncNgExampleComponent);
